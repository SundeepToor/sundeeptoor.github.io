<div class="blog">
  ...
  <li>need to demonstrate some design concepts to other people, communicate what you're about or build enthusiasm with people</li>
  <li>a polished bran dtheme/logo/sample page design might be useful to get feedback on</li>
  </ul>
  <p>During analysis</p>
  <ul>
  ...
  <p>Good Information architecture</p>
  <ul>
